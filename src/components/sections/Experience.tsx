    ...
    >
      <div className="container">
        ...
        <ol className="relative mx-auto mt-14 max-w-3xl">
          ...
          <span
            aria-hidden
            className="absolute left-[1.375rem] top-3 hidden h-[calc(100%-2rem)] w-px bg-gradient-to-b from-brand-300 via-brand-200 to-transparent sm:block dark:from-brand-400/70 dark:via-brand-400/30"
          />
              ...
              <li key={`${item.role}-${item.organization}`}>
                <Reveal variants={slideInLeft} delay={index * 0.08}>
                  <div className="relative flex gap-5 pb-10 sm:gap-6">
                    <div className="hidden h-11 w-11 shrink-0 items-center justify-center rounded-full border border-brand-200 bg-card text-brand-500 shadow-soft sm:flex dark:border-brand-400/30 dark:text-brand-300">
        ...
        <Reveal variants={fadeIn} className="mx-auto mt-6 max-w-3xl">
          <div className="rounded-3xl border border-border bg-card p-7 shadow-soft sm:p-8">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-50 text-brand-500 dark:bg-brand-400/15 dark:text-brand-300">
